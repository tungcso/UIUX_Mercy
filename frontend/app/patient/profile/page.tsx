...
export default function PatientProfilePage() {
  ...
  return (
    <main className="flex h-full min-h-0 justify-center bg-[#e9f5ed] px-2 py-2 sm:px-4 sm:py-5">
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[20px] font-bold leading-tight">Nguyễn Văn An</p>
                <p className="mt-0.5 text-[13px] text-white/80">Nam · 28 tuổi</p>
                <button
                  type="button"
                  onClick={copyId}
        ...
        <BottomSheet onClose={() => setActiveSheet(null)}>
          {activeSheet === "edit" && (
            <EditSheet
              ...
              onSave={() => { setActiveSheet(null); showNotice("Đã lưu thông tin cá nhân."); }}
            />
          )}
          {activeSheet === "qr" && (
      ...
      {/* ── Toast notice ── */}
      {notice ? (
        <div className="fixed bottom-24 left-1/2 z-[60] -translate-x-1/2 rounded-2xl bg-[#1f2939] px-4 py-2.5 text-[13px] font-medium text-white shadow-[0_16px_40px_rgba(15,23,42,0.28)]">
          {notice}
        </div>
      ) : null}
    ...
    <>
      ...
      <div className="px-5 pb-5 pt-3">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className="flex items-center gap-2 rounded-2xl bg-[#16a34a] px-4 py-2 text-[13px] font-medium text-white"
            >
        ...
        <div className="space-y-3">
          {[
            { label: "Họ và tên", value: "Nguyễn Văn An", type: "text" },
            { label: "Số điện thoại", value: "0901 234 567", type: "tel" },
            { label: "Ngày sinh", value: "1998-05-24", type: "date" },
            { label: "Địa chỉ", value: "Thanh Xuân, Hà Nội", type: "text" },
            { label: "Người liên hệ khẩn cấp", value: "Trần Thu H - 0912 345 678", type: "text" },
          ].map((field) => (
            <div key={field.label}>
